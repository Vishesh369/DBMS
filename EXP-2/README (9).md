...
## Experiment
Experiment 2 : Understanding and implementing SQL SELECT queries using WHERE, GROUP BY, HAVING, and ORDER BY clauses to retrieve and analyze data from relational database tables.
...
![Step 1: Average salary by department](Exp-2_Screenshots/S5.png)
